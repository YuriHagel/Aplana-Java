...
public class Generate {
  ...
  public static String generateMiddleName() {
    ...
    middleNamePool.add("Петрович");
    middleNamePool.add("Иванович");
    String middleName = middleNamePool.get(random.nextInt(middleNamePool.size()));
    return middleName;
  }
  ...
  public static GroupContact generatePerson(String email) {
    return new GroupContact (Generate.generateLastName(), Generate.generateFirstName(),
